...
//    }
    ...
    public static FrequencyNetwork fromNbt(UUID id, NbtCompound tag, RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        network.getStorage().readNbtList(tag.getList("storage", NbtCompound.COMPOUND_TYPE), wrapperLookup);
        ...
        for (int i = 0; i < allBeaconsList.size(); i++) {
            ...
            BeaconNode beaconNode = BeaconNode.fromNBT(nbtCompound, wrapperLookup);
    ...
    public void writeToNbt(NbtCompound tag, RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        tag.put("storage", this.getStorage().toNbtList(wrapperLookup));
        NbtList allBeaconsList = new NbtList();
        beacons.values().forEach(beaconNode -> allBeaconsList.add(beaconNode.toNBT(wrapperLookup)));
